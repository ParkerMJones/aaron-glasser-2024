...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-md bg-[oklch(0.955_0_0)] p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
